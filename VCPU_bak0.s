...
* [X] Menu->Settings->Backdrop   Yes/No
* [X] Menu->Settings->Borderless Yes/No
* [_] ToolTypes Load/Save
* [_] Iconify
* [_] Commodity
* [_] Skin engine
* 
...
.wbStart
	...
	tst.l      pr_CLI(a4)                      ; process->pr_CLI
	bne.s      .openLibs                       ; skip
...
MenuItem_About:
	...
	move.l     #APP_AUTHOR,2*4(a4)             ; array[2]
	move.l     #APP_COMMENT,3*4(a4)            ; array[3]
	move.l     #APP_COPYRIGHT,4*4(a4)          ; array[4]
...
MenuItem_Setting_Skin:
	...
	lea.l      .skinsTbl(pc),a1                ; table
	move.l     (a1,d2.w*4),(a0)                ; store new
	bsr        Window_Reopen                   ; close and reopen
	movem.l    (sp)+,d0-a6                     ; pop
	rts                                        ; return
.skinsTbl:
	DC.L FileWinBG1,FileWinBG2,FileWinBG3,FileWinBG4
	DC.L FileWinBG5,FileWinBG6,FileWinBG7,FileWinBG8,0
...
.picload4
	lea.l      FileBarBG2(pc),a0               ; filename
	lea.l      GuiGfxTags(pc),a1               ; tags
	CALLGUIGFX LoadPictureA                    ; (filename,tags)(a0,a1)
	tst.l      d0                              ; 
	beq        .psmdel                         ; 
	move.l     d0,GuiGfxPic4                   ; pic

.picload5
	lea.l      FileBarFG2(pc),a0               ; filename
	lea.l      GuiGfxTags(pc),a1               ; tags
	CALLGUIGFX LoadPictureA                    ; (filename,tags)(a0,a1)
	tst.l      d0                              ; 
	beq        .psmdel                         ; 
	move.l     d0,GuiGfxPic5                   ; pic
...
.picadd4
	move.l     GuiGfxPenShareMap(pc),a0        ; psm
	move.l     GuiGfxPic4(pc),a1               ; picture
	lea.l      GuiGfxTags(pc),a2               ; tags
	CALLGUIGFX AddPictureA                     ; (psm,pic,tags)(a0,a1,a2)
	tst.l      d0                              ; 
	beq        .psmdel                         ; 
...
.picadd5
	move.l     GuiGfxPenShareMap(pc),a0        ; psm
	move.l     GuiGfxPic5(pc),a1               ; picture
	lea.l      GuiGfxTags(pc),a2               ; tags
	CALLGUIGFX AddPictureA                     ; (psm,pic,tags)(a0,a1,a2)
	tst.l      d0                              ; 
	beq        .psmdel                         ; 
...
.barinit
	...
	lea.l      BarCF(pc),a0                    ; bar flops
	lea.l      BarTags(pc),a1                  ; bar tags
	move.l     #100,bar_PicW(a0)               ; 
	move.l     #010,bar_PicH(a0)               ; 
	move.l     GuiGfxPic2(pc),bar_PicBg(a0)    ; 
	move.l     GuiGfxPic3(pc),bar_PicFg(a0)    ; 
*	move.l     GuiGfxPic4(pc),bar_PicBg(a0)    ; 
*	move.l     GuiGfxPic5(pc),bar_PicFg(a0)    ; 
	move.l     GuiGfxDrawHandle(pc),bar_hDraw(a0)
	move.l     a1,bar_hTags(a0)                ; 
...
.delpic4
	tst.l      GuiGfxPic4(pc)                  ; picture
	beq.s      .delpic5                        ; 
	move.l     GuiGfxPic4(pc),a0               ; 
	CALLGUIGFX DeletePicture                   ; (picture)(a0)
	clr.l      GuiGfxPic4                      ; 

.delpic5
	tst.l      GuiGfxPic5(pc)                  ; picture
	beq        .deldrawhandle                  ; 
	move.l     GuiGfxPic5(pc),a0               ; 
	CALLGUIGFX DeletePicture                   ; (picture)(a0)
	clr.l      GuiGfxPic5                      ; 
...
.winMenu
	...
	cmp.w      #0,d0                           ; 
	beq.s      .winMenu0                       ; menu0
	cmp.w      #1,d0                           ; 
	beq.s      .winMenu1                       ; menu1
	cmp.w      #2,d0                           ; 
	beq.s      .winMenu2                       ; menu2
	bra        .continue                       ; 

.winMenu0
	cmp.w      #0,d1                           ; menu0, item0
	beq.s      .winMenu00                      ; 
	cmp.w      #1,d1                           ; menu0, item1
	beq.s      .winMenu01                      ; 
	cmp.w      #3,d1                           ; menu0, item3
	beq.s      .winMenu02                      ; 
	cmp.w      #5,d1                           ; menu0, item5
	beq.s      .winMenu03                      ; 
	bra        .continue                       ; skip
.winMenu1
	cmp.w      #0,d1                           ; menu1, item0
	beq.s      .winMenu10                      ; 
	cmp.w      #1,d1                           ; menu1, item1
	beq.s      .winMenu11                      ; 
	cmp.w      #2,d1                           ; menu1, item2
	beq.s      .winMenu12                      ; 
	cmp.w      #4,d1                           ; menu1, item4
	beq.s      .winMenu13                      ; 
	cmp.w      #5,d1                           ; menu1, item5
	beq.s      .winMenu14                      ; 
	cmp.w      #7,d1                           ; menu1, item7
	beq.s      .winMenu15                      ; 
	bra        .continue                       ; skip
.winMenu2
	cmp.w      #0,d1                           ; menu2, item0
	beq.s      .winMenu20                      ; 
	cmp.w      #2,d1                           ; menu2, item2
	beq.s      .winMenu21                      ; 
	cmp.w      #3,d1                           ; menu2, item3
	beq.s      .winMenu22                      ; 
	cmp.w      #5,d1                           ; menu2, item5
	beq.s      .winMenu23                      ; 
	bra        .continue                       ; skip
.winMenu00
	bsr        MenuItem_Help                   ; [Project->Help]
	bra        .continue                       ; 
.winMenu01
	bsr        MenuItem_Iconify                ; [Project->Iconify]
	bra        .continue                       ; 
.winMenu02
	bsr        MenuItem_About                  ; [Project->About]
	bra        .continue                       ; 
.winMenu03
	bra        .exit                           ; [Project->Quit]
.winMenu10
	bsr        MenuItem_FPUSwitch              ; [Tools->FPUSwitch]
	bra        .continue                       ; 
.winMenu11
	bsr        MenuItem_SuperScalar            ; [Tools->SuperScalar]
	bra        .continue                       ; 
.winMenu12
	bsr        MenuItem_TurtleMode             ; [Tools->TurtleMode]
	bra        .continue                       ; 
.winMenu13
	bsr        MenuItem_FastIDE                ; [Tools->FastIDE]
	bra        .continue                       ; 
.winMenu14
	bsr        MenuItem_SDClockDivider         ; [Tools->SDClockDiv]
	bra        .continue                       ; 
.winMenu15
	bsr        MenuItem_SerialNumber           ; [Tools->SerialNumber]
	bra        .continue                       ; 
.winMenu20
	bsr        MenuItem_Setting_RefreshRate    ; [Settings->Rate]
	bra        .continue                       ; 
.winMenu21
	bsr        MenuItem_Setting_Backdrop       ; [Settings->Backdrop]
	bra        .continue                       ; 
.winMenu22
	bsr        MenuItem_Setting_Borderless     ; [Settings->Borderless]
	bra        .continue                       ; 
.winMenu23
	bsr        MenuItem_Setting_Skin           ; [Settings->Skins]
	bra        .continue                       ; 
	nop

	;----------------------------------------
	; System-Friendly delay
	;----------------------------------------
	
.continue
	;
	bsr        Window_UpdateCNT                ; update counters
	bsr        Window_UpdateLED                ; update clock led
	bsr        Window_UpdateTXT                ; update infos text
	;
	moveq.l    #2,d1                           ; ticks
	CALLDOS    Delay                           ; 
	bra.w      .loop                           ; 
...
Window_UpdateCNT:
	...
	move.l     ValCounter_CC(pc),d0            ; 
	move.l     d1,d2                           ; 
	sub.l      d0,d1                           ; 
	cmp.l      d4,d1                           ; 
	blo        .exit                           ; 
	move.l     d2,ValCounter_CC                ; 
	lea.l      TxtCounterCol(pc),a3            ; 

	;------------------------------------------
	; Processor Counter Pipe 1
	;------------------------------------------
	
	move.l     ValCounter_C1(pc),d1            ; (old)
	dc.w       $4e7a,SPR_IP1                   ; (new)
	move.l     d0,ValCounter_C1                ; (new)
	sub.l      d1,d0                           ; (new-old)
	...
	lea.l      BarC1(pc),a0                    ; bar
	move.l     d0,bar_Val1(a0)                 ; new
	bsr        BarDraw1                        ; update

	lea.l      MyITextC1(pc),a2                ; color0: zero
	...
	move.l     ValCounter_C2(pc),d1            ; (old)
	dc.w       $4e7a,SPR_IP2                   ; (new)
	move.l     d0,ValCounter_C2                ; (new)
	sub.l      d1,d0                           ; (new-old)
	mulu.l     #100,d0                         ; (new-old)*100
	divu.l     d4,d0                           ; (new-old)*100/rate
	sne        d2                              ; non-zero
	...
	lea.l      BarC2(pc),a0                    ; bar
	move.l     d0,bar_Val1(a0)                 ; new
	bsr        BarDraw1                        ; update

	lea.l      MyITextC2(pc),a2                ; color0: zero
	move.b     (a3,d2.L*1),it_FrontPen(a2)     ; color1: non-zero
	...
	move.l     ValCounter_CF(pc),d1            ; (old)
	dc.w       $4e7a,SPR_STH                   ; (new)
	move.l     d0,ValCounter_CF                ; (new)
	sub.l      d1,d0                           ; (new-old)
	mulu.l     #100,d0                         ; (new-old)*100
	divu.l     d4,d0                           ; (new-old)*100/rate
	sne        d2                              ; non-zero
	...
	lea.l      BarCF(pc),a0                    ; bar
	move.l     d0,bar_Val1(a0)                 ; new
	bsr        BarDraw1                        ; update

	lea.l      MyITextCF(pc),a2                ; color0: zero
	move.b     (a3,d2.L*1),it_FrontPen(a2)     ; color1: non-zero
	...
	move.l     MyWindow(pc),a0                 ; window
	move.l     wd_RPort(a0),a0                 ; rastport
	lea.l      MyITextC1(pc),a1                ; textfont
	move.l     #0,d0                           ; x.w
	move.l     #0,d1                           ; y.w
	CALLINT    PrintIText                      ; (rp,itext,x,y)(a0,a1,d0,d1)
...
ValCounter_CC: DC.L 0
ValCounter_C1: DC.L 0
ValCounter_C2: DC.L 0
ValCounter_CF: DC.L 0
TxtCounterArr: DC.L 0
TxtCounterTot: DC.L 0
TxtCounterCol: DC.B 4,2
TxtCounterFmt: DC.B "IPC: %ld.%02ld",0
	CNOP 0,4
...
.pen4
	...
	add.l      #vp_ColorMap,a0                 ; win->scr->vp.cm
	move.l     (a0),a0                         ; cm
	move.l     #$00000000,d1                   ; r
	move.l     #$ffffffff,d2                   ; g
	move.l     #$00000000,d3                   ; b
	lea.l      ObtainBestPenTags(pc),a1        ; tags
	CALLGRAF   ObtainBestPenA                  ; (cm,r,g,b,tags)(a0,d1,d2,d3,a1)
	move.l     d0,PenLEDColor4                 ; store

*	lea.l      MyIText4(pc),a0
*	move.b     d0,it_FrontPen(a0)
*	lea.l      MyIText5(pc),a0
*	move.b     d0,it_FrontPen(a0)
*	lea.l      MyIText6(pc),a0
*	move.b     d0,it_FrontPen(a0)
...
*MEMFLAGS_CHIP EQU (MEMF_CHIP!MEMF_TOTAL)
*MEMFLAGS_FAST EQU (MEMF_FAST!MEMF_TOTAL)
*MEMFLAGS_SLOW EQU (MEMF_FAST!MEMF_TOTAL!MEMF_24BITDMA)
...
.getMemChip
	move.l     $4.w,a0                         ; execbase
	move.l     #MEMFLAGS_CHIP,d1               ; flags
	CALLEXEC   AvailMem                        ; (flags)(d1)
	divu.l     #(1024*1024),d0                 ; size
	move.l     d0,ValCHIP                      ; size
	lea.l      FmtCHIP(pc),a0                  ; fmt
	lea.l      ValCHIP(pc),a1                  ; args
	lea.l      RawDoFmtCallback(pc),a2         ; cb
...
.getMemFast
	move.l     $4.w,a0                         ; execbase
	move.l     #MEMFLAGS_FAST,d1               ; flags
	CALLEXEC   AvailMem                        ; (flags)(d1)
	divu.l     #(1024*1024),d0                 ; size
	move.l     d0,ValFAST                      ; size
	lea.l      FmtFAST(pc),a0                  ; fmt
	lea.l      ValFAST(pc),a1                  ; args
	lea.l      RawDoFmtCallback(pc),a2         ; cb
...
.getMemSlow
	...
	CALLEXEC   AvailMem                        ; (flags)(d1)
	divu.l     #(1024*1024),d0                 ; size
	move.l     d0,ValSLOW                      ; size
	lea.l      FmtSLOW(pc),a0                  ; fmt
	lea.l      ValSLOW(pc),a1                  ; args
	lea.l      RawDoFmtCallback(pc),a2         ; cb
...
RtcTags:
	...
	DC.L GGFX_SourceHeight,6
	DC.L GGFX_DestWidth,90
	DC.L GGFX_DestHeight,6
	DC.L TAG_DONE

TxtTags:
	DC.L GGFX_SourceX,22
	DC.L GGFX_SourceY,170
	DC.L GGFX_SourceWidth,16
	DC.L GGFX_SourceHeight,16
	DC.L GGFX_DestWidth,16
	DC.L GGFX_DestHeight,16
	DC.L TAG_DONE

CntTags:
	DC.L GGFX_SourceX,114
	DC.L GGFX_SourceY,114
	DC.L GGFX_SourceWidth,48
	DC.L GGFX_SourceHeight,6
	DC.L GGFX_DestWidth,48
	DC.L GGFX_DestHeight,6
	DC.L TAG_DONE
...
MyNewMenu:
	...
	MENUITEM   NM_SUB,StrMenu2A1
	MENUITEM   NM_SUB,StrMenu2A2
	MENUITEM  NM_ITEM,StrMenu2B
	MENUITEM   NM_SUB,StrMenu2B1
	MENUITEM   NM_SUB,StrMenu2B2
	MENUITEM  NM_ITEM,StrMenu2C
	MENUITEM   NM_SUB,StrMenu2C1
	MENUITEM   NM_SUB,StrMenu2C2
	MENUITEM  NM_ITEM,NM_BARLABEL
	MENUITEM  NM_ITEM,StrMenu2D
	MENUITEM   NM_SUB,StrMenu2D1
	MENUITEM   NM_SUB,StrMenu2D2
	MENUITEM   NM_SUB,StrMenu2D3
	MENUITEM   NM_SUB,StrMenu2D4
	MENUITEM  NM_ITEM,StrMenu2E
	MENUITEM   NM_SUB,StrMenu2E1
	MENUITEM   NM_SUB,StrMenu2E2
	MENUITEM   NM_SUB,StrMenu2E3
	MENUITEM   NM_SUB,StrMenu2E4
	MENUITEM   NM_SUB,NM_BARLABEL
	MENUITEM   NM_SUB,StrMenu2E5
	MENUITEM  NM_ITEM,NM_BARLABEL
	MENUITEM  NM_ITEM,StrMenu2F
	MENUITEM NM_TITLE,StrMenu3
	MENUITEM  NM_ITEM,StrMenu3A
	MENUITEM   NM_SUB,StrMenu3A1
	MENUITEM   NM_SUB,StrMenu3A2
	MENUITEM   NM_SUB,StrMenu3A3
	MENUITEM   NM_SUB,StrMenu3A4
	MENUITEM   NM_SUB,StrMenu3A5
	MENUITEM   NM_SUB,StrMenu3A6
	MENUITEM  NM_ITEM,NM_BARLABEL
	MENUITEM  NM_ITEM,StrMenu3B
	MENUITEM   NM_SUB,StrMenu3B1
	MENUITEM   NM_SUB,StrMenu3B2
	MENUITEM  NM_ITEM,StrMenu3C
	MENUITEM   NM_SUB,StrMenu3C1
	MENUITEM   NM_SUB,StrMenu3C2
	MENUITEM  NM_ITEM,NM_BARLABEL
	MENUITEM  NM_ITEM,StrMenu3D
	MENUITEM   NM_SUB,StrMenu3D1
	MENUITEM   NM_SUB,StrMenu3D2
	MENUITEM   NM_SUB,StrMenu3D3
	MENUITEM   NM_SUB,StrMenu3D4
	MENUITEM   NM_SUB,StrMenu3D5
	MENUITEM   NM_SUB,StrMenu3D6
	MENUITEM   NM_SUB,StrMenu3D7
	MENUITEM   NM_SUB,StrMenu3D8
	MENUITEM NM_END,0
...
MenuTbl0:
	DC.L MenuItem_Help
	DC.L MenuItem_Iconify
	DC.L MenuItem_Void
	DC.L MenuItem_About
	DC.L MenuItem_Void
	DC.L MenuItem_Quit
MenuTbl1:
	DC.L MenuItem_FPUSwitch
	DC.L MenuItem_SuperScalar
	DC.L MenuItem_TurtleMode
	DC.L MenuItem_Void
	DC.L MenuItem_FastIDE
	DC.L MenuItem_SDClockDivider
	DC.L MenuItem_Void
	DC.L MenuItem_SerialNumber
MenuTbl2:
	DC.L MenuItem_Setting_RefreshRate
	DC.L MenuItem_Void
	DC.L MenuItem_Setting_Backdrop
	DC.L MenuItem_Setting_Borderless
	DC.L MenuItem_Void
	DC.L MenuItem_Setting_Skin
...
MyIText1: ITEXT 1,1,0,00,044,MyTextA1,StrCPU1,MyIText2
MyIText2: ITEXT 2,1,1,14,154,MyTextA1,StrBoard0,MyIText3
MyIText3: ITEXT 2,1,0,00,061,MyTextA2,StrFREQ,MyIText4
MyIText4: ITEXT 2,1,0,00,069,MyTextA2,StrMULT,MyIText5
MyIText5: ITEXT 2,1,0,14,170,MyTextA3,StrCHIP,MyIText6
MyIText6: ITEXT 2,1,0,14,176,MyTextA3,StrFAST,MyIText7
MyIText7: ITEXT 2,1,0,14,182,MyTextA3,StrSLOW,MyIText8
MyIText8: ITEXT 1,1,0,00,140,MyTextA3,StrTEMP,MyIText9
MyIText9: ITEXT 1,1,0,00,055,MyTextA3,StrREV,0

MyITextC1:  ITEXT 4,1,0,046,121,MyTextA3,StrC1,MyITextC2
MyITextC2:  ITEXT 4,1,0,046,127,MyTextA3,StrC2,MyITextCF
MyITextCF:  ITEXT 4,1,0,046,133,MyTextA3,StrCF,MyITextIPC
MyITextIPC: ITEXT 2,1,0,114,114,MyTextA3,StrIPC,0
...
ReqSNBody:
	DC.B "Serial-Number of your Vampire",10,10
	DC.B "0x%s",0
...
FileBarFG2:       DC.B "PROGDIR:Gfx/BarFG2.png",0
FileBarBG2:       DC.B "PROGDIR:Gfx/BarBG2.png",0
...
APP_RELEASEDATE:  DC.B "11.11.2019",0
APP_AUTHOR:       DC.B "flype",0
APP_COMMENT:      DC.B "ALPHA VERSION · DONT SHARE",0
APP_COPYRIGHT:    DC.B "(C) 2016-2019 APOLLO-Team",0

APP_VERSTRING:
	DC.B "$VER: VCPU 0.1c (11.11.2019) "
